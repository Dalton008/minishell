...
${NAME} : $(OBJ) $(OBJ_CMD) $(OBJ_UTILS) $(OBJ_PIPE) $(OBJ_LIST_SIGNAL) $(HEADER)
	gcc $(READLINE) $(FLAGS) $(OBJ) $(OBJ_CMD) $(OBJ_UTILS) $(OBJ_PIPE) $(OBJ_LIST_SIGNAL) -o $(NAME)

clean :
	$(RM) $(OBJ) $(OBJ_CMD) $(OBJ_UTILS) $(OBJ_PIPE) $(OBJ_LIST_SIGNAL)
