...
LIST_UTILS = utils/ft_atoi.c utils/ft_split.c utils/ft_strcmp.c utils/ft_putchar_fd.c utils/ft_putstr_fd.c \
	...
	utils/ft_bzero.c utils/ft_calloc.c utils/utils.c utils/ft_isalnum.c utils/ft_trim.c \
	utils/dup_fd.c utils/ft_isdigit.c

LIST_CMD = commands/cmd_pwd.c commands/cmd_echo.c commands/cmd_env.c commands/cmd_export.c \
	commands/cmd_cd.c commands/cmd_unset.c commands/other_cmd.c commands/cmd_exit.c commands/easter_egg.c

LIST_PARSER = parser/preparser.c parser/parser.c parser/do_dollar.c parser/init_env.c parser/parse_fd.c
